...
<p> <a href="cadastra_nomenclatura_rede.php">Cadastrar Hosts</a><br></p>
 ...
 <?php 
   ...
   @mysql_select_db($db);//selecione o banco de dados
           ...
           $sqltudo = mysql_query("SELECT * FROM nomenclatura_rede ORDER BY endereco_ip")  or die(mysql_error());
	   ...
	   print'</tr></b>';
           ...
           $sistema_original = @mysql_result($sqltudo, $j, "so_original");
