...
?>
<div id="l2" class="div-margin"></div>
<blockquote>
...
<a href="#l1"><img src=images/verde.png></a><br/>
...
if(isset($_POST['done'])){   
    ...
    $colaborador_retorno = $_POST['colaborador_procura'];
           ...
           $sqltudo = mysql_query("select  * FROM nomenclatura_rede  where colaborador like UPPER('$colaborador_retorno%') order by endereco_ip ")  or die(mysql_error());
 ...
 if ($tipo_equipamento == "ESTACAO") {
	   ...
	   if ($tipo_equipamento == "IMPRESSORA") {
		...
		$contador_nobreak++;
		   ...
		   if ($tipo_equipamento == "BATERIAS") {
		$contador_baterias++;
           }
		   if ($tipo_equipamento == "DVR") {
		$contador_dvr++;
           }
		   if ($tipo_equipamento == "RELOGIO") {
		$contador_relogio++;
           }
		   if ($tipo_equipamento == "CATRACA") {
		$contador_catraca++;
           }
		   if ($tipo_equipamento == "PABX") {
		$contador_pabx++;
           }
...
print '<li>';
echo 'NoBreaks: ';
echo $contador_nobreak;
print '</li>';
print '<br>';

print '<li>';
echo 'Banco de Baterias: ';
echo $contador_baterias;
print '</li>';
print '<br>';
...
<div id="l1" class="div-margin"></div>
</font>
<font size=4>
<a href="#l2"><img src=images/vermelha.png></a><br/>
</body>
</html>
